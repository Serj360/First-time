...
Welcome, and thanks for stopping by! This README gives an overview of my work, projects, and documentation habits.
I also maintain a Notion-based portfolio that's more visual and it also includes labs, and ongoing learning.
...
> 
- IT work is often intangible. Documentation lets employers see real, verifiable skill—not just claims.
- A portfolio reduces the “risk” for hiring managers by showing how I think, troubleshoot, and execute projects.
- It also reinforces information I’ve learned; not everything sticks unless it’s written, organized, and reviewed.
- A few supporting sources:
    - *“Personal projects and home labs in IT improve hands-on skills, problem-solving, and critical thinking”*  ([invent.org](https://www.invent.org/blog/trends-stem/benefit-from-hands-on-learning?utm_source=chatgpt.com)).
...
- Intro video: https://youtu.be/gp2yhkVw0z4
